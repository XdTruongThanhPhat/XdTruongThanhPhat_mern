...
const Footer = () => {
  return (
    <footer className="bg-black text-white pt-16 pb-8 border-t-4 border-green-500 mt-5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="space-y-4">
            <h3 className="text-red-400 text-lg font-bold uppercase tracking-widest mb-4">
              Trường Thành Phát
            </h3>
            ...
            {/* Mạng xã hội */}
                ...
                <a 
                    ...
                    className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center text-gray-400 hover:bg-green-500 hover:text-white transition-colors duration-300"
                >
                ...
                {/* Zalo - Bạn hãy thay số điện thoại vào link bên dưới */}
                <a 
          ...
          <div>
            <h4 className="text-lg font-bold uppercase tracking-widest mb-4">Liên Kết Nhanh</h4>
            <div className="w-8 h-1 bg-green-500 mb-6"></div>
          ...
          <div>
            <h4 className="text-lg font-bold uppercase tracking-widest mb-4">Thông Tin Liên Hệ</h4>
            <div className="w-8 h-1 bg-green-500 mb-6"></div>
          ...
          <div className="h-full">
            <h4 className="text-lg font-bold uppercase tracking-widest mb-4">Trụ sở văn phòng</h4>
            <div className="w-8 h-1 bg-green-500 mb-6"></div>
            <div className="w-full h-48 md:h-56 rounded-md overflow-hidden border border-gray-800 shadow-sm relative group">
              {/* Đã lồng ghép chính xác link bản đồ và chuẩn hóa cú pháp React */}
              <iframe 
