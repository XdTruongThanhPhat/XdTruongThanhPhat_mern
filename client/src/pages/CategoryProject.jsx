        ...
        <div className="flex flex-wrap justify-center items-center gap-2 md:gap-6 mb-8 md:mb-16 relative z-10">
          {categoryMap.map((cat) => (
            <button
              ...
              className={`px-3 py-1.5 md:px-5 md:py-2 text-[10px] md:text-sm font-bold uppercase tracking-widest transition-all duration-300 border rounded-full ${activeTab === cat.name
              ...
              <div className="mt-8 md:mt-16 flex justify-center items-center gap-1 md:gap-2">
                ...
                {[...Array(totalPages)].map((_, index) => (
                  <button
                    ...
                    className={`w-7 h-7 md:w-10 md:h-10 text-[10px] md:text-xs font-bold transition-all duration-300 rounded-sm border ${currentPage === index + 1
